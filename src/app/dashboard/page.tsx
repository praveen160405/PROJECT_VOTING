  ...
  return (
    <div className="flex flex-col gap-8 p-2 md:p-0">
      <div className="flex justify-between items-center">
        ...
        <Badge variant="outline" className="h-10 px-4 rounded-xl border-primary/20 bg-primary/5 text-primary gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((s) => (
          <Card key={s.label} className="glassmorphic-card rounded-2xl border-white/5 shimmer-card">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="glassmorphic-card rounded-2xl border-primary/20 bg-primary/5 flex flex-col justify-between">
            ...
            <CardContent className="p-8 pt-0">
              <Link href="/dashboard/vote"><Button className="w-full h-12 rounded-xl uppercase font-black tracking-widest bg-primary text-background">Initiate Protocol</Button></Link>
            </CardContent>
          </Card>
          <Card className="glassmorphic-card rounded-2xl border-accent/20 bg-accent/5 flex flex-col justify-between">
            <CardHeader className="p-8 pb-4">
            ...
            <CardContent className="p-8 pt-0">
              <Link href="/dashboard/verify"><Button className="w-full h-12 rounded-xl uppercase font-black tracking-widest bg-accent text-background">Execute Audit</Button></Link>
            </CardContent>
          </Card>
        </div>

        <Card className="glassmorphic-card rounded-2xl border-white/5 p-8 flex flex-col gap-6">
